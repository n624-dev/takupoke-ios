...
swiftc -swift-version 5 -parse-as-library \
    ...
    Takupoke/ChangeNormalizer.swift Takupoke/TimetableLessonNames.swift Takupoke/PDFSchoolParser.swift Takupoke/MaterialLibrary.swift Takupoke/WebPDFDownloader.swift \

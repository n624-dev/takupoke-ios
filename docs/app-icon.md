...
- 通常は白背景・茶色の「たく」、ダークは黒に近い背景・明るい茶色（#D4AA80）の「たく」です。「ポケ」・赤い線・鉛筆の配色は維持します。`icon.json` のappearance指定を使用し、ホーム画面で選んだアイコン外観に従ってOSが切り替えます。光沢、影、角丸マスクとLiquid Glassの描画もOSへ任せます。

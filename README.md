...
**現在は資料取得と時間割変更XLSXの解析に対応する開発版です。PDF解析・通常時間割との統合はまだありません。実機で報告されたXLSX書式の問題を修正しており、この修正版のiOSビルド・実機確認は待機中です。**
...
| XLSX解析・結果確認 | 数式・AI表記への対応と警告付きプレビューを追加。この修正版のiOSビルド・実機確認待ち |
| PDF解析・時間割統合 | 未実装 |
| 通知・バックグラウンド更新 | 未実装 |

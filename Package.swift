    ...
    targets: [
        .target(name: "TakupokeParsing", dependencies: ["ZIPFoundation", .product(name: "GRDB", package: "GRDB.swift")], path: "Takupoke",
                exclude: ["Assets.xcassets", "Info.plist", "PrivacyInfo.xcprivacy", "ThirdPartyNotices.txt",
                          ...
                          "MaterialsView.swift", "ChangeAnalysisView.swift", "WebPDFDownloader.swift", "PDFAnalysisView.swift", "TimetableView.swift", "SpecialSchedulesModel.swift"],
        ...
        .testTarget(name: "ParsingTests", dependencies: ["TakupokeParsing", "ZIPFoundation", .product(name: "GRDB", package: "GRDB.swift")], path: "tests",
                    ...
                    sources: ["ParsingTests.swift", "TimetableNameTests.swift", "PDFParsingTests.swift", "PDFTextGeometryTests.swift", "LocalDatabaseTests.swift", "SchoolDateTests.swift", "TimetableScheduleTests.swift", "SpecialScheduleTests.swift"], resources: [.copy("fixtures")])
    ]
)
